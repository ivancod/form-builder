...
class VS_FormBuilder_Front
{
	...
	public function __construct() 
	{
        ...
        add_shortcode( 'fb_form_builder', array($this, 'form_view') );
	}

	public function form_view( $arg )
	{
		...
		if($form_id == 0 OR $form_id == '' OR $form_id == '0') {
			return;
		}
